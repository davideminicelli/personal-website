  ...
  return (
    <div>
      <div>
        ...
        <div className="my-8">
          <h2 className="mb-2 text-3xl/none font-black leading-none">
            <LanguageSwitch
...
const clientsList = [
  {
    url: "/images/client-adidas.jpg",
    label: "adidas",
  },
  {
    url: "/images/client-schwarzkopf.jpg",
    label: "Schwarzkopf",
  },
  {
    url: "/images/client-decathlon.jpg",
    label: "Decathlon",
  },
  {
    url: "/images/client-hasbro.jpg",
    label: "Hasbro",
  },
  {
    url: "/images/client-henkel.jpg",
    label: "Henkel",
  },
  {
    url: "/images/client-britvic.jpg",
    label: "Britvic",
  },
  {
    url: "/images/client-kepak.jpg",
    label: "Kepak",
  },
  {
    url: "/images/client-robinsons.jpg",
    label: "Robinsons",
  },
];
