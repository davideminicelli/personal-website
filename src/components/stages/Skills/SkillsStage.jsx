...
const SkillsStage = () => {
  ...
  const inView1 = useInView(wrapper1Ref, { once: true });

  const wrapper2Ref = useRef(null);
  const inView2 = useInView(wrapper2Ref, { once: true });

  const wrapper3Ref = useRef(null);
  const inView3 = useInView(wrapper3Ref, { once: true });

  const wrapper4Ref = useRef(null);
  const inView4 = useInView(wrapper4Ref, { once: true });

  const wrapper5Ref = useRef(null);
  const inView5 = useInView(wrapper5Ref, { once: true });
  ...
  const skillsList = [
    {
      ...
      url: "/images/techs/tech-styled-components.jpg",
      category: "styling",
    },
    {
      name: "Framer Motion",
      ...
      url: "/images/techs/tech-motion.jpg",
      category: "styling",
    },
    {
      name: "Sass",
      description: {
        ...
        it: "Sass estende il CSS con funzionalità come variabili e nesting, offrendo un modo più organizzato ed efficiente di scrivere fogli di stile. Viene compilato in CSS standard per la compatibilità con tutti i browser web.",
      },
      url: "/images/techs/tech-sass.jpg",
      category: "styling",
    },
    {
      name: "Tailwind CSS",
      ...
      url: "/images/techs/tech-tailwind.jpg",
      category: "styling",
    },
    {
      name: "JavaScript",
      ...
      url: "/images/techs/tech-javascript.jpg",
      category: "scripting",
    },
    {
      name: "React",
      ...
      url: "/images/techs/tech-react.jpg",
      category: "scripting",
    },
    {
      name: "Next.js",
      ...
      url: "/images/techs/tech-next.jpg",
      category: "scripting",
    },
    {
    ...
    },
    {
      ...
      url: "/images/techs/tech-docker.jpg",
      category: "tools",
    },
    {
      name: "Blender",
      ...
      url: "/images/techs/tech-blender.png",
      category: "3d",
    },
    {
      name: "Three.js",
      ...
      url: "/images/techs/tech-three.png",
      category: "3d",
    },
    {
      name: "A-Frame",
      ...
      url: "/images/techs/tech-aframe.jpg",
      category: "3d",
    },
  ];
  ...
  return (
    <div className="max-width-container">
      ...
      <div className="flex flex-wrap" ref={wrapper1Ref}>
        {skillsList
      ...
      <div>
        ...
        <div className="flex flex-wrap" ref={wrapper2Ref}>
          {skillsList
      ...
      <div>
        ...
        <div className="flex flex-wrap" ref={wrapper3Ref}>
          {skillsList
      ...
      <div>
        ...
        <div className="flex flex-wrap" ref={wrapper4Ref}>
          {skillsList
      ...
      <div>
        ...
        <div className="flex flex-wrap" ref={wrapper5Ref}>
          {skillsList
